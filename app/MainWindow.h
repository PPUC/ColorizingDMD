...
private:
    ...
    std::vector<int> playbackFrameIndices() const;
    ...
    class CanvasWidget* m_playbackCanvas = nullptr;
    class QWidget* m_playbackTab = nullptr;
    ...
    class QToolButton* m_previewPlayButton = nullptr;
    class QToolButton* m_previewStopButton = nullptr;
    class QToolButton* m_previewPauseButton = nullptr;
    class QToolButton* m_previewPrevButton = nullptr;
    ...
    int m_playbackPos = -1;
    QElapsedTimer m_playbackFrameClock;
    QElapsedTimer m_playbackRotationClock;
    SerumEditorRotationState m_playbackRotationState;
    const uint16_t* m_playbackRotationData = nullptr;
    int m_playbackWidth = 0;
    int m_playbackHeight = 0;
    std::vector<uint16_t> m_playbackBase565;
